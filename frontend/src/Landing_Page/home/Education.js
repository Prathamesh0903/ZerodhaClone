        ...
        <div className='container '>
          <div className='row'>
            ...
            <div className='col-6'>
                 ...
                 <a href='#' style={{textDecoration:"none"}}>Versity<i class="fa-solid fa-arrow-right-long mx-2" ></i></a>
                 ...
                 <a href='#'style={{textDecoration:"none"}}>TradingQ&A<i class="fa-solid fa-arrow-right-long mx-2" ></i></a>
            </div>
          </div>
